...
function mytheme_register_block_patterns() {
	$block_pattern_categories = array(
		'featured'              => array( 'label' => __( 'Featured', 'blocktheme' ) ),
		'footer'                => array( 'label' => __( 'Footers', 'blocktheme' ) ),
		'header'                => array( 'label' => __( 'Headers', 'blocktheme' ) ),
		'query'                 => array( 'label' => __( 'Query', 'blocktheme' ) ),
		'mytheme_pages' => array( 'label' => __( 'Pages', 'blocktheme' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'mytheme_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'mytheme_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'blocktheme/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'mytheme_register_block_patterns', 9 );
